...
if __name__ == '__main__':
    ...
    assert config.BATCH_SIZE<=len(train_data.color_filelist_train), "The batch size should be smaller or equal to the number of training images --> modify it in config.py"
